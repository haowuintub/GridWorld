...
package gridworld.framework.world;

import gridworld.framework.grid.BoundedGrid;
import gridworld.framework.grid.Grid;
import gridworld.framework.grid.Location;
import gridworld.framework.gui.WorldFrame;
...
public class World<T>
{
    ...
    public World(Grid<T> g)
    {
        ...
        addGridClass("gridworld.framework.grid.BoundedGrid");
        addGridClass("gridworld.framework.grid.UnboundedGrid");
    }
